...
> **Attention** N'essayez pas dans la suite du TP de changer le répertoire du travail avec `set_wd`, car dans les documents Rmarkdown, le répertoire de travail est toujours le répoertoire dans lequel le document Rmarkdown est enregistré. A l'avenir, nous nous déplacerons toujours de manière relative à ce répertoire là.
