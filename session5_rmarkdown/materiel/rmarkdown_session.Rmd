...
## Taille et légende de l'image et 
...
> **Challenge** Jouez avec `toc` et `toc_float` en les passant à no pour découvrir quel est exactement leur rôle.
...
# Ajouter un référence bibliographique au format standard
