...
Le premier chunk doit être conservé. Il permet de configurer des options gloable pour les chunks du documents, nous y reviendrons plus tard dans la séance. Dans ce premier chunk, rajoutez l'import des packages que nous allons utiliser: "ggplot2", "ggpubr", "gglm", "equatiomatic", "papeR", "knitr", "plotly". Exécutez le chunk, au moyen de la petite flèche verte en haut à droite du chunk, ou avec `Ctrl+Shift+Enter`.
...
Exécutez le chunk. Vous devriez voir apparaître en dessous un aperçu de la sortie de la fonction.
