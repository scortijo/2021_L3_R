...
> **Exercice:**
>
> Calculez la médiane, la moyenne et l'écart-type de `blade.length.mm` et `total.leaf.length.mm` pour chaque `genotype` au différentes `day.length`. Ajoutez aussi le nombre d'observations de chaque groupe 
>
>
...
>
> Ensuite, en utilisant les outils que vous avez vu ces dernières semaines, effectuez ces changements.
>
>
