...
Dans notre cas, la colonne `fluctuation` va permettre de créer les noms de colonnes dans la nouvelle table. Et la colonne `days.to.bolt` contient les valeurs qui vont remplir les nouvelles colonnes. 
