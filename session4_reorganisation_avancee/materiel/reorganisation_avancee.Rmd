...
- *Extraire des statistiques résumant les données (group_by et summarise s'il y a le temps)*
...
Afin de pouvoir reproduire les couleurs du graphique, nous devons concatener les colonnes `temperature` et `day.length`.
...
## Combinier plusieurs tableaux en un
