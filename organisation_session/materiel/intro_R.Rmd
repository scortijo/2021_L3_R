...
Sur la page d'aide, nous pouvons voir que la fonction `round()` accpete deux arguments appelés "x" et "digits". "x" est le nombre que nous voulons arrondir et "digits" est le nombre de chiffres apres la virgules que nous voulons.
