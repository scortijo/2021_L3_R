...
# (Répondez un expliquant quelle commande vous permet de répondre)
...
# résultats préliminaires effectués sur ces deux gènes?
...
# Faites la même chose pour la table contennant tous les gènes. 
