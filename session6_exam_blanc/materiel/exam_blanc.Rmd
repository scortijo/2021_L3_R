...
Utilisez des zones de code de Rmarkdown pour répondre à la question à l'aide de commandes.
...
>Pour commencer, ouvrez _exam_blanc.Rmd_ et sauvez le dans le dossier _session6_exam_blanc_ en y ajoutant votre nom. 
...
- **AT3G12580**: Il s'agit d'une Heat Shock Proetin (HSP70) qui répond à la chaleur. Les chercheurs ont préalablement observé que l'expression de AT3G12580 augmente à 27°C de manière rapide et atteint son pic d'expression en 15 minutes avant de redescendre.
...
Combien de gènes de _data_expression_cortijo2017.txt_ sont régulés par HSFA1a
