...
Pour aller plus loin, les auteurs ont regroupé ensemble les gènes qui ont des profils d'expression similaires au cours du temps. Par exemple tous les gènes qui ont une augmentation qui monte avec le temps en réponse à la chaleur ont été regroupé ensemble. De cette manières ils ont identtifié **7 groupes**, appelés **clusters**.
...
Les chercheurs sont plus intéressés par le cluster 1 (qui contient AT1G04520) et le cluster 6A (qui contient AT3G12580).
