...
Dans cette partie du cours vous allez apprendre à manipuler et changer la structure de tables dans R. 
...
- Combiner ces manipulations avec des graphiques
...
# Changez votre répertoire de travail pour être dans `session3_plots_manipulation`
