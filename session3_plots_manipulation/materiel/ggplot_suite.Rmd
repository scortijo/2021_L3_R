...
- Idéalement, et si cela se prête à votre question, montrez les données plutôt que des résumés. Choisissez des nuages de points plutôt que des parplots avec des barres d'erreur. 
...
![](./boxplot.png){width=70%} [source de l'image](https://www.leansigmacorporation.com/box-plot-with-minitab/)
...
![](./boxplot_jitter.png){width=70%} [source de l'image](https://www.data-to-viz.com/caveat/boxplot.html)


- - Si vous avez trop de points pour les représenter dans le graphique, vous pouvez utiliser un violin plot  en indiquand la taille de l'effectif de chaque groupe:
![](./violin.png){width=70%} [source de l'image](https://www.data-to-viz.com/caveat/boxplot.html)
