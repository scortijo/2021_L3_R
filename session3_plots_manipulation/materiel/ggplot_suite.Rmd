...
p1 <- ggdraw() + draw_image("images/lollipot_non_ordonne.png", scale = 0.9)
p2 <- ggdraw() + draw_image("images/lollipot_ordonne.png", scale = 0.9)
...
p1 <- ggdraw() + draw_image("images/spaghetti_solution_separees.png", scale = 0.9)
p2 <- ggdraw() + draw_image("images/spaghetti_solution_couleur.png", scale = 0.9)
...
p4 <- ggdraw() + draw_image("images/point_sature.png", scale = 0.9)
p5 <- ggdraw() + draw_image("images/densite_2D.png", scale = 0.9)
p6 <- ggdraw() + draw_image("images/densite_3D.png", scale = 0.9)
