...
- Un scatterplot montrant la relation entre le nombre de feuilles et le nombre de jours jusqu'a floraison, coloré en fonction du traitement: 
...
- Des boxplots du nombre de jours jusqu'a floraison pour les différent génotypes, séparés en fonction de la témpérature, et colorés en fonction du traitement (fluctuation ou non):
...
### Trouver le graphique approprié à nos données et à notre question
